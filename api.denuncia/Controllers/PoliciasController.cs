...
namespace api.denuncia.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PoliciasController : ControllerBase
    {
        private readonly apidenunciaContext _context;

        public PoliciasController(apidenunciaContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Policias
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Policia>>> GetPolicia()
        {
        ...
        public async Task<ActionResult<Policia>> PostPolicia(Policia policia)
        {
            ...
            return CreatedAtAction("GetPolicia", new { id = policia.CIP }, policia);
        }
        ...
        {
            return _context.Policias.Any(e => e.CIP == id);
        }
    }
}
